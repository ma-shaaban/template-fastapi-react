...
setup — the app already contains everything the AI needs: the house rules
(`AGENTS.md`), a task board it keeps for you (`docs/ai-tasks/`), and tests
that catch mistakes before they ship.
...
> "Change the heading on the home page to say 'Welcome to __APP__'."
...
(<https://__APP__-staging.nezam.site>) automatically — usually within a few
...
A few minutes later the new version is live on
...
you decide when to release. If you're ever unsure, ask the AI to explain
what it's proposing.
