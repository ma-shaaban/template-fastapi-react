...
Welcome! **__APP__** is your app, running on the Nezam platform.
...
- **Staging** — <https://__APP__-staging.nezam.site> — a preview of the
  latest work. This is where every change shows up first, so you can look at
  it before anyone else does.
- **Production** — <https://__APP__.nezam.site> — the real, released version
