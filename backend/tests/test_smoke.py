"""Smoke tests for the template's API contract. Keep these green forever —
they cover the endpoints the platform itself relies on (/healthz for
readiness, /api/version for deploy verification)."""
